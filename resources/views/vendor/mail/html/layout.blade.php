...
<head>
    ...
    <style type="text/css">
        ...
        img.icon { width: 18px; height:18px; margin-right: 10px;}
                ...
                <table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                                            ...
                                            <tr>
                                                <td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="flexibleContainer">
                                                        <tr>
                                                            <td align="left" valign="top" class="flexibleImage">
                                                                <img src="{{asset('logo_new.png')}}" class="" />                                                                    </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#000;" bgcolor="black">
                                <tr>
                                    <td align="center" valign="top">
                                        <!-- FLEXIBLE CONTAINER // -->
                                        <!--
                                            ...
                                            <tr>
                                                <td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="flexibleContainer">
                                                        <tr>
                                                            <td align="left" valign="top" class="flexibleImage">
{{--                                                                <img src="{{asset('assets/img/email/email-pic.png')}}" class="" />                                                                    </td>--}}
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
